...
const Projects = () => {
  return (
    <div
      name="projects"
      className="max-w-[1280px] h-full mx-auto mt-32 px-5 bg-primary"
    >
      <h2 className="py-3 text-3xl md:text-7xl font-bold flex justify-center mb-3 md:mb-10">
        {projectsText.title}
      </h2>
      <p className="text-lg md:text-2xl text-center mb-4 md:mb-10">
        {projectsText.subHeading}
      </p>
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 justify-items-center">
        ...
        <div className="max-w-sm bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
          ...
          <div className="p-5">
            ...
            <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
              Website created with HTML, CSS, and JavaScript. An external API is
              used to retrieve weather data. The website has a build function
        ...
        <div className="max-w-sm bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
          ...
          <div className="p-5">
            ...
            <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
              ...
              HTML, CSS, and Bootstrap. The goal of this website was to showcase
              different types of fishing equipment that you could rent.
            </p>
            <a
              href="https://mihaelpavlakovic.github.io/ribic/"
              target="_blank"
